...
import 'package:flutter_web_portfolio/widgets/icon.dart';
  ...
  Widget _buildContactInfo(String imagePath, String title, String content) {
    return FittedBox(
      child: Row(
        ...
        children: [
          AppIcon(imagePath,
              color: AppColors.kBlackColor.withOpacity(.7), size: 20),
          ...
          Column(
            ...
            children: [
              ...
              Text(
                content,
                style: TextStyle(color: AppColors.kBlackColor.withOpacity(.7)),
              ),
            ],
          )
        ],
